...
def parse_args():
    ...
    parser.add_argument("--max_episode", type=int, default=50020, help="maximum episode length")
    ...
    parser.add_argument("--beita", type=int, default=0.97, help="reward discount factor")
    parser.add_argument("--mae_ratio", type=int, default=0.4, help="the ratio of MAE")
    parser.add_argument("--lr_a", type=float, default=1e-2, help="learning rate for adam optimizer")
    parser.add_argument("--lr_l", type=float, default=1e-3, help="learning rate for adam optimizer")
    ...
    parser.add_argument("--start_save_model", type=int, default=1500, help="the number of the episode for saving the model")
    parser.add_argument("--save_dir", type=str, default="./models", 
            help="directory in which training state and model should be saved")
    parser.add_argument("--save_data_dir", type=str, default="./data", 
            help="directory in which training data should be saved")
    parser.add_argument("--old_model_name", type=str, default="models/simple_adversary_2112_132325_2210000/", \
            help="directory in which training state and model are loaded")
# simple_adversary_2106_141654_530000
# simple_push_2106_141726_530000
# simple_tag_2106_170852_6410000
# simple_spread_2106_151419_1290000
